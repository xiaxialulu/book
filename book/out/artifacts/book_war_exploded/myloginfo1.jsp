                ...
                <div class="layui-tab-item layui-field-box layui-show">
                    <table class="layui-table table-hover" lay-even="" lay-skin="nob">
                        ...
                        <tr>
                            ...
                            <td>${b.press}</td>
                            <td>${b.intro}</td>
                            <td><a href="${pageContext.request.contextPath}/book_toUpdate.action?id=${b.id}">修改</a> | <a href="${pageContext.request.contextPath}/book_deleteBook.action?id=${b.id}" onclick="javascript:return confirm('确认删除？')">删除</a></td>
                        </tr>
                        </c:forEach>
                        </tbody>
                    </table>
                    <%--<div class="larry-table-page clearfix">
                        <a href="personInfo2.html" class="layui-btn layui-btn-small"><i class="iconfont icon-shanchu1"></i>添加</a>
