    ...
    <div class="layui-header header header-demo">
        <div class="layui-main">
            ...
            <div class="admin-logo-box">
                <a class="logo" href="http://www.kuxuebao.net" title="logo">图书管理系统</a>
            ...
            <ul class="layui-nav larry-header-item">
                <li class="layui-nav-item">
                    账户名：${sessionScope.admin.username}
                </li>
                ...
                <li class="layui-nav-item">
                    <a href="${pageContext.request.contextPath}/admin_loginout.action">
            ...
            <ul class="layui-nav layui-nav-tree">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" data-url="${pageContext.request.contextPath}/personInfo.jsp">
                        ...
                        <dd>
                            <a href="javascript:;" data-url="${pageContext.request.contextPath}/book_selectBook.action">
